...
parcheggi = T([1,2])([25,10])(parcheggi)
...
viale5 = CUBOID([80,10])
viale5 = T([1,2])([-15,58])(viale5)




completo = STRUCT([solid_model_3D, prato, parcheggi, palazzi12, viale1, palazzo3, palazzo4, viale2, viale5])
VIEW(completo)